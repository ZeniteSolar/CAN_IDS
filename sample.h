...
#define CAN_FILTER_MSG_MOTOR_MOTOR_BYTE 1 //<!" Switches and states
...
#define CAN_FILTER_MSG_MOTOR_D_RAW_BYTE 2 //<!" Motor Duty Cycle
#define CAN_FILTER_MSG_MOTOR_D_RAW_TYPE "u8"
#define CAN_FILTER_MSG_MOTOR_D_RAW_UNITS "%"
#define CAN_FILTER_MSG_MOTOR_I_RAW_BYTE 3 //<!" Motor Soft Start
#define CAN_FILTER_MSG_MOTOR_I_RAW_TYPE "u8"
#define CAN_FILTER_MSG_MOTOR_I_RAW_UNITS "%"
